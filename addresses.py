...
class AddressRequester():
    ...
    def requests_in_rectangle(latitude_min, longitude_min, latitude_max, longitude_max, delta):
        ...
        while latitude < latitude_max:
            ...
            while longitude < longitude_max:
                requests.append(AddressRequester.request_url(latitude, longitude))
                longitude += delta
        return requests 
    ...
    def request_all_in_rectangle(latitude_min, longitude_min, latitude_max, longitude_max, delta):
        urls = AddressRequester.requests_in_rectangle(latitude_min, longitude_min, latitude_max, longitude_max, delta)
...
if __name__ == "__main__":
    ...
    res = AddressRequester.request_all_in_rectangle(37.8331415, -121.9827142, 37.8351415, -121.9807142, .001)
    print(res)
